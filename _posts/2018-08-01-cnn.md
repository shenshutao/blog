...
指数加权平均是一种非常常见的序列数据处理方式，比如预测股价。参数为$$\beta$$，可以用来短期波动的干扰，保留长期趋势。可以用来计算下一个时刻的预测值。  
![ewa]({{ site.baseurl }}/img/cnn/ewa.png){:width="250px"}.   
...
![momentum]({{ site.baseurl }}/img/cnn/momentum.jpg){:width="200px"}     
